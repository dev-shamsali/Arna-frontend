...
const MIN_VISIBLE_TIME = 1500   // minimum time logo stays visible
const FADE_OUT_DURATION = 1000  // fade-out duration
...
export default function IntroLoader({ onFinish }) {
  ...
  return (
    ...
    >
      ...
      {/* NEUTRAL SPOTLIGHT (CRITICAL FOR LOGO VISIBILITY) */}
      <div
        className="
          absolute inset-0
