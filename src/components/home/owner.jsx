                    ...
                    <div className="lg:col-span-7 space-y-10 lg:space-y-12">
                        ...
                        >
                            ...
                            <h3 className="text-xl md:text-3xl font-serif text-white mb-6 leading-tight">
                                A blend of <span className="font-calligraphy text-4xl md:text-6xl text-[#b77f6b] normal-case">Ar</span><span className="font-calligraphy text-4xl md:text-6xl text-white normal-case">man</span> and <span className="font-calligraphy text-4xl md:text-6xl text-[#b77f6b] normal-case">Na</span><span className="font-calligraphy text-4xl md:text-6xl text-white normal-case">az</span>,
