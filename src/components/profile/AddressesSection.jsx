      ...
      <div className="space-y-4">
        ...
        {!isAdding && !editingId && (
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-green-300 hover:bg-green-50 transition-colors"
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              ...
              <div className="flex items-center space-x-2 ml-auto">
                <button
                  ...
                  className="p-2 text-green-600 hover:bg-green-100 rounded-lg transition-colors group-hover:opacity-100 opacity-75"
                  title="Edit"
                >
                  <Edit3 size={18} />
                </button>
                <button
                  ...
                  className="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors group-hover:opacity-100 opacity-75"
                  title="Delete"
                >
                  <Trash2 size={18} />
                </button>
