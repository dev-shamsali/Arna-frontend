...
export default function CartPageContent() {
  ...
  return (
    <>
      {/* CART SECTION - Added padding-top to account for fixed navbar */}
                ...
                <div className="mt-4 sm:mt-5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-xs sm:text-sm border rounded-full outline-none focus:ring-1 focus:ring-emerald-500"
                    />
                    <button className="px-4 py-2 text-xs sm:text-sm font-medium rounded-full border border-gray-200 hover:bg-gray-50 transition">
                      Apply
                    </button>
                  </div>
                </div>
