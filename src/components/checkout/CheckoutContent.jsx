...
export default function CheckoutContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 pt-20 sm:pt-24 pb-8 sm:pb-12">
        {/* Payment Section */}
        <section className="mb-6">
          <h1 className="text-xl sm:text-2xl font-semibold mb-1 text-gray-900">Payment</h1>
        ...
        {/* Billing Address */}
        <section className="mb-6">
          <h2 className="text-lg font-semibold mb-3 text-gray-900">Billing address</h2>
        ...
        <section className="border rounded-xl p-4 sm:p-5 bg-white">
          <h2 className="text-lg sm:text-xl font-serif font-semibold mb-4 pb-3 border-b text-gray-900">
            Order summary
          </h2>
